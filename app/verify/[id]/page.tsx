    ...
    <div className="cert-outer" ref={certRef}>
      ...
      <div className="cert-content">
        ...
        <p className="body-text">
          ...
          <strong>120-Hour Internship Programme</strong> in{" "}
          <strong>{data.course}</strong> ({data.semester}) under the curriculum
          of <strong>Social Work &amp; Human Management</strong> at{" "}
    ...
    <div className="mob-cert">
      ...
      <div className="mob-content">
        ...
        <p className="mob-body">
          has successfully completed a{" "}
          <strong>120-Hour Internship Programme</strong> in{" "}
          <strong>{data.course}</strong> ({data.semester}) under{" "}
...
.sig-sign { height: 4em; max-width: 8em; object-fit: contain; }
.sig-seal { height: 5em; max-width: 8em; object-fit: contain; }
.sig-line {
  width: 85%; height: 1px;
